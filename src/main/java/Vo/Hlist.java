...
public class Hlist {
	private String Horario_entrada_turno,Hora_salida_turno,usuario,corrreo;
...
public Hlist(String horario_entrada_turno, String hora_salida_turno, String usuario, String corrreo, int idempleado) {
	super();
