...
private String usuario,horario_entrada,descripcion_horaentrada,descripcion_horasalida,horario_salida; 
...
public reportehorarioVo(String usuario, String horario_entrada, String descripcion_horaentrada,
		String descripcion_horasalida, String horario_salida) {
	super();
	this.usuario = usuario;
	this.horario_entrada = horario_entrada;
	this.descripcion_horaentrada = descripcion_horaentrada;
